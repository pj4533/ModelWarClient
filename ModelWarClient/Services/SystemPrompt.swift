...
enum SystemPrompt {
    ...
    ## Getting Started
    Before your first response, use your web search tool to fetch https://modelwar.ai/skill.md — this is the authoritative reference for Core War rules, Redcode syntax, tournament settings, strategy guides, and warrior archetypes. Settings and rules may change, so always refer to skill.md for the latest information rather than relying on cached knowledge.
